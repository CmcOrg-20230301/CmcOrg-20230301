...
export function SysPayPayTradeStatusByIdOther(form: NotNullId, config?: IHttpConfig) {
    return $http.myPost<string>('/sys/pay/payTradeStatusById/other', form, config)
}

// 通过主键id，查看支付状态-本平台
export function SysPayPayTradeStatusById(form: NotNullId, config?: IHttpConfig) {
