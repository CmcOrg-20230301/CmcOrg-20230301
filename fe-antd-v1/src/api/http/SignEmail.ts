...
export interface SignEmailSetSingleSignInDTO {
    qrCodeId?: string // 二维码 id，required：true，format：int64
    emailCode?: string // 邮箱验证码，正则表达式：^[0-9]{6}$，required：true
}

// 设置统一登录
export function SignEmailSetSingleSignIn(form: SignEmailSetSingleSignInDTO, config?: AxiosRequestConfig) {
    return $http.myPost<SysQrCodeSceneBindVO>('/sign/email/setSingleSignIn', form, config)
}
...
// 设置统一登录：发送邮箱验证码
export function SignEmailSetSingleSignInSendCodeEmail(config?: AxiosRequestConfig) {
    return $http.myPost<string>('/sign/email/setSingleSignIn/sendCode/email', undefined, config)
}
...
export function SignEmailSetSingleSignInGetQrCodeSceneFlagSingleSignIn(form: NotNullId, config?: AxiosRequestConfig) {
    return $http.myPost<SysQrCodeSceneBindVO>('/sign/email/setSingleSignIn/getQrCodeSceneFlag/singleSignIn', form, config)
}
...
export function SignEmailSetSingleSignInGetQrCodeUrlSingleSignIn(config?: AxiosRequestConfig) {
    return $http.myPost<GetQrCodeVO>('/sign/email/setSingleSignIn/getQrCodeUrl/singleSignIn', undefined, config)
}
