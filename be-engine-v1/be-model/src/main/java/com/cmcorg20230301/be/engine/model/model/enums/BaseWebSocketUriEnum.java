...
public enum BaseWebSocketUriEnum implements IWebSocketUri {
    ...
    SYS_IM_SESSION_REF_USER_JOIN_USER_ID_SET(
        "/sys/im/session/refUser/join/userIdSet"), // im-聊天加入新的用户

    SYS_SOCKET_REF_USER_CHANGE_CONSOLE_FLAG_BY_ID_SET(
        "/sys/socketRefUser/changeConsoleFlagByIdSet"), // 打开/关闭 控制台
