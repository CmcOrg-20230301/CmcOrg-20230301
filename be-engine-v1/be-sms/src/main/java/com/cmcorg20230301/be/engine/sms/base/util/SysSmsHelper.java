...
public class SysSmsHelper {
    ...
    @Resource
    public void setSysSmsConfigurationService(
        SysSmsConfigurationService sysSmsConfigurationService) {
     ...
     * 获取：SysSmsSendBO对象
     */
    public static SysSmsSendBO getSysSmsSendBO(@Nullable Long tenantId, String sendContent,
        String phoneNumber) {
    ...
    public static SysSmsSendBO getSysSmsSendBO(String sendContent, String phoneNumber, Long id) {
        ...
        SysSmsConfigurationDO sysSmsConfigurationDO = sysSmsConfigurationService.lambdaQuery()
     ...
     */
    @NotNull
    public static SysSmsConfigurationDO getSysSmsConfigurationDO(@Nullable Long tenantId,
        Integer sysSmsType,
        ...
        List<SysSmsConfigurationDO> sysSmsConfigurationDOList =
            sysSmsConfigurationService.lambdaQuery().eq(BaseEntityNoIdSuper::getTenantId, tenantId)
                ...
                .eq(SysSmsConfigurationDO::getType, sysSmsType).list();
        ...
        if (CollUtil.isEmpty(sysSmsConfigurationDOList)) {
            ...
            if (BooleanUtil.isTrue(useParentTenantSmsFlag)) {
                ...
                // 递归：获取上级租户的短信方式
                sysSmsConfigurationDO = handleUseParentTenantSmsFlag(tenantId, tenantId,
    ...
    public static SysSmsConfigurationDO getDefaultSysSmsConfigurationDO(@Nullable Long tenantId,
        ...
        if (sysSmsConfigurationDO == null) {
            ...
            ApiResultVO.error("操作失败：未配置默认短信方式，请联系管理员",
    ...
    public static void handleSysSmsConfigurationDO(SysSmsSendBO sysSmsSendBO) {
        ...
        if (sysSmsConfigurationDO == null) {
            ...
            if (sysSmsSendBO.getSmsType() == null) { // 如果是：默认短信
                ...
                sysSmsConfigurationDO = getSysSmsConfigurationDO(sysSmsSendBO.getTenantId(),
                    sysSmsSendBO.getSmsType(),
                    sysSmsSendBO.getUseParentTenantSmsFlag());
     ...
     */
    @NotNull
    public static SysSmsConfigurationDO handleUseParentTenantSmsFlag(Long tenantIdOriginal,
        ...
        if (UserUtil.getCurrentTenantTopFlag(currentTenantId)) {
            ...
            ApiResultVO.error("操作失败：未配置短信发送，请联系管理员",
                StrUtil.format("tenantIdOriginal：{}，currentTenantId：{}", tenantIdOriginal,
                    currentTenantId));
        ...
        LambdaQueryChainWrapper<SysSmsConfigurationDO> lambdaQueryChainWrapper =
            sysSmsConfigurationService.lambdaQuery()
                .eq(BaseEntityNoIdSuper::getTenantId, currentTenantId)
                .eq(BaseEntityNoId::getEnableFlag, true);
        ...
        if (sysSmsConfigurationDO == null) {
            ...
            // 递归：获取上级租户的短信方式
            return handleUseParentTenantSmsFlag(tenantIdOriginal, currentTenantId,
                lambdaQueryChainWrapperConsumer);
