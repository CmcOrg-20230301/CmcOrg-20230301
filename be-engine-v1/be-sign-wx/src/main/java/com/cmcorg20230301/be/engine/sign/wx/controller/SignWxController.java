...
public class SignWxController {
    ...
    public ApiResultVO<SysQrCodeSceneBindVO>
        updateSignInNameGetQrCodeSceneFlag(@RequestBody @Valid NotNullId notNullId) {
    ...
    public ApiResultVO<SysQrCodeSceneBindVO>
        setSingleSignInWxGetQrCodeSceneFlagCurrent(@RequestBody @Valid NotNullId notNullId) {
        return ApiResultVO.okData(baseService.setSingleSignInWxGetQrCodeSceneFlagCurrent(notNullId));
    }
    ...
    public ApiResultVO<SysQrCodeSceneBindVO> setSingleSignInWx(@RequestBody @Valid SignWxSetSingleSignInWxDTO dto) {
    ...
    public ApiResultVO<SysQrCodeSceneBindVO>
        setSingleSignInPhoneGetQrCodeSceneFlagCurrent(@RequestBody @Valid NotNullId notNullId) {
        return ApiResultVO.okData(baseService.setSingleSignInPhoneGetQrCodeSceneFlagCurrent(notNullId));
    }

    @PostMapping(value = "/setSingleSignIn/phone/sendCode")
    @Operation(summary = "设置统一登录：手机验证码：发送验证码")
    public ApiResultVO<String>
        setSingleSignInPhoneSendCode(@RequestBody @Valid SignWxSetSingleSignInPhoneSendCodeDTO dto) {
    ...
    public ApiResultVO<SysQrCodeSceneBindVO>
        setSingleSignInPhone(@RequestBody @Valid SignWxSetSingleSignInPhoneDTO dto) {
