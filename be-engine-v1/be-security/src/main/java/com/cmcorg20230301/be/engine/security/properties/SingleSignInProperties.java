...
public class SingleSignInProperties {
    ...
    @Schema(description = "微信扫码登录的 sys_other_app表主键 id")
    private Long wxSysOtherAppId;

    @Schema(description = "短信登录的 sys_sms_configuration表主键 id")
    private Long smsConfigurationId;

    @Schema(description = "邮箱登录的 sys_email_configuration表主键 id")
