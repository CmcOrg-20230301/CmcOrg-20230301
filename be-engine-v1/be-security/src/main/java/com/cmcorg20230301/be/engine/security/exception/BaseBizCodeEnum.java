...
/**
 * 规则： 错误代码格式：300010 300021 解释：前面5位：错误代码，最后一位：0，系统异常，1，业务异常 注意：10001开头的留给 BaseBizCodeEnum类进行配置，建议用
 * 20001开头配置一些公用异常，实际业务从 30001开头，开始使用 备注：可以每个业务的错误代码配置类，使用相同的 错误代码，比如每个业务的错误代码配置类都从 30001开始，原因：因为
...
public enum BaseBizCodeEnum implements IBizCode {
    ...
    OPERATION_TIMED_OUT_PLEASE_TRY_AGAIN(100161,
        "操作超时，请重新进行操作"), // 返回这个 code（100161），前端会在步骤表单，往前返回步骤
