...
public interface SysImSessionApplyService extends IService<SysImSessionApplyDO> {
    ...
    Page<SysImSessionApplyPrivateChatFindNewPageVO> privateChatFindNewPage(
        SysImSessionApplyPrivateChatFindNewPageDTO dto);

    Page<SysImSessionApplyPrivateChatApplySelfPageVO> privateChatApplyPageSelf(
        SysImSessionApplyPrivateChatApplySelfPageDTO dto);

    Page<SysImSessionApplyPrivateChatSelfPageVO> privateChatPageSelf(
