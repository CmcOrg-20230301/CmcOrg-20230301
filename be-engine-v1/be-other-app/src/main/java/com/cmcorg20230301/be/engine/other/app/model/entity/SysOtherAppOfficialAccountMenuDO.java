...
import com.cmcorg20230301.be.engine.other.app.model.enums.SysOtherAppOfficialAccountButtonTypeEnum;
import com.cmcorg20230301.be.engine.other.app.model.enums.SysOtherAppOfficialAccountTypeEnum;
...
public class SysOtherAppOfficialAccountMenuDO extends BaseEntityTree<SysOtherAppOfficialAccountMenuDO> {
    ...
    private SysOtherAppOfficialAccountTypeEnum type;

    @Schema(description = "按钮类型")
    private SysOtherAppOfficialAccountButtonTypeEnum buttonType;
