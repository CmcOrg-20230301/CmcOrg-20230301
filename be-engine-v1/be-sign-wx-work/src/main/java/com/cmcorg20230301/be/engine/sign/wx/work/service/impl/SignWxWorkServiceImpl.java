...
public class SignWxWorkServiceImpl implements SignWxWorkService {
    ...
    public SignInVO signInBrowserCode(SignInBrowserCodeDTO dto) {
        ...
        WxWorkOpenIdVO wxWorkOpenIdVO =
            WxUtil.getWxWorkBrowserOpenIdVoByCode(dto.getTenantId(), dto.getCode(), dto.getAppId());
        ...
        return SignUtil.signInAccount(
            ChainWrappers.lambdaQueryChain(sysUserMapper).eq(SysUserDO::getWxOpenId, openId).eq(SysUserDO::getWxAppId,
                dto.getAppId()),
            BaseRedisKeyEnum.PRE_WX_OPEN_ID, openId, SysUserInfoUtil::getWxWorkSysUserInfoDO, dto.getTenantId(),
            accountMap -> {
