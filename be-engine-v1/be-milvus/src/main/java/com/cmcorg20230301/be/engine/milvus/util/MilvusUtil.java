...
public class MilvusUtil {
     ...
     */
    public static final List<String> FIELD_NAME_LIST = CollUtil.newArrayList(ID_FIELD_NAME, TENANT_ID_FIELD_NAME,
        USER_ID_FIELD_NAME, ENABLE_FLAG_FIELD_NAME, RESULT_FIELD_NAME, VECTOR_TEXT_FIELD_NAME);
    ...
    public static boolean createAndLoadCollection(String collectionName, int vectorLength,
        ...
        FieldType resultFieldType = FieldType.newBuilder().withName(RESULT_FIELD_NAME).withDataType(DataType.VarChar)
            .withMaxLength(2000).build();

        FieldType vectorTextFieldType = FieldType.newBuilder().withName(VECTOR_TEXT_FIELD_NAME)
            .withDataType(DataType.VarChar).withMaxLength(2000).build();

        FieldType vectorListFieldType = FieldType.newBuilder().withName(VECTOR_LIST_FIELD_NAME)
            .withDataType(DataType.FloatVector).withDimension(vectorLength).build();
    ...
    public static String match(List<Float> floatList, String collectionName, String resultFieldName,
        ...
        SearchResultsWrapper searchResultsWrapper = doMatch(floatList, collectionName,
            Collections.singletonList(resultFieldName), vectorFieldName, score, exprStr);
     ...
     *            {@link com.cmcorg20230301.be.engine.milvus.mode.entity.milvus.BaseMilvusDO} 该类，方便统一管理
     */
